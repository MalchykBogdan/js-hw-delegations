...
function openModal(url) {
  ...
  lightboxImage.alt = galleryItems.find(item => item.original === url).description;

  lightbox.classList.add('is-open');
}

document.querySelector('[data-action="close-lightbox"]').addEventListener('click', closeModal);
